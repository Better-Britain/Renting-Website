  ...
  return (
    <div>
      ...
      <main>
        ...
        <section className='p-16'>
          <h1 className='text-xl mb-4'>Mission Statement</h1>
        ...
        <section className='p-16 bg-red-uk text-white-uk'>
          <h1 className='text-xl mb-4'>Why?</h1>
        ...
        <section className='p-16'>
          <h1 className='text-xl mb-4'>Proposal</h1>
        ...
        <section className='p-16 bg-blue-uk text-white-uk'>
        ...
        <section className='p-16'>
          <h1 className='text-xl mb-4'>Additional Ideas: Rent Equity</h1>
